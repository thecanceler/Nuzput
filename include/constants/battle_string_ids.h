...
#define STRINGID_CHIVALRYDOESNTALLOW 567
#define STRINGID_CHIVALRYACTIVATES 568
#define STRINGID_PKMNCUTHPMAXEDSPATTACK            569
...
#define B_MSG_SWITCHIN_CHIVALRY	 15
